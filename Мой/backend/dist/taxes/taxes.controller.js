...
let TaxesController = class TaxesController {
    ...
    async findOne(id) {
        return this.taxesService.findOne(parseInt(id));
    }
    async create(createTaxDto) {
        return this.taxesService.create(createTaxDto);
    }
    async update(id, updateTaxDto) {
        return this.taxesService.update(parseInt(id), updateTaxDto);
    }
    async remove(id) {
        return this.taxesService.remove(parseInt(id));
    }
};
...
exports.TaxesController = TaxesController = __decorate([
    (0, common_1.Controller)('api/taxes'),
