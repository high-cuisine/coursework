...
let FinesController = class FinesController {
    ...
    async findOne(id) {
        return this.finesService.findOne(parseInt(id));
    }
    async create(createFineDto) {
        return this.finesService.create(createFineDto);
    }
    async update(id, updateFineDto) {
        return this.finesService.update(parseInt(id), updateFineDto);
    }
    async remove(id) {
        return this.finesService.remove(parseInt(id));
    }
};
...
exports.FinesController = FinesController = __decorate([
    (0, common_1.Controller)('api/fines'),
